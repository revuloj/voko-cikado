...
stil-dosiero. Eblas ankau meti la aprtajn regulojn en
la TEI-dokumenton mem.

TEI-dokumentoj uzataj kun tiuj chi stildifinoj sekvi kelkajn
konvenciojn:
...
<xsl:template match="/">
  <html>
    ...
    <!-- kadraro -->
    <frameset cols="38%,*">
      <frame name="enhavo" src="_enhavo.html" />
      <frame scrolling="yes" name="precipa" src="_titolo.html" />
      <noframes>
        <a href="_titolo.html">senkadra versio</a>
      </noframes>
    </frameset>
...
<xsl:template match="teiHeader">
  <xsl:call-template name="_enhavo"/>
  <xsl:call-template name="_teksto"/>
</xsl:template>

<xsl:template name="_teksto">
  <xt:document method="html" version="4.0" 
               encoding="utf-8" href="_titolo.html">  
    <html>
      <head>
...
<xsl:template name="_enhavo">
  <xt:document method="html" version="4.0" 
               encoding="utf-8" href="_enhavo.html">  
    <html>
      <head>
        <link title="dokumento-stilo" type="text/css" rel="stylesheet"
              href="../css/{$stylesheet}" />
